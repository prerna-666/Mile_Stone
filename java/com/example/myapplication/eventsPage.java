...
import com.example.myapplication.databinding.ActivityEventsPageBinding;
...
public class eventsPage extends AppCompatActivity {
    ...
    private ActivityEventsPageBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sqLitehelper.queryData("CREATE TABLE IF NOT EXISTS EVENT (Id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR, price VARCHAR, image BLOB)");

        Cursor cursor = sqLitehelper.getData("SELECT * FROM EVENT");
        list.clear();
